...
describe('My First Test', function() {
  it("Gets, types and asserts", function() {
    ...
    cy.get ('#app > div > form > button').click()
    cy.get('#app > div > table > tbody > tr:nth-child(1) > td:nth-child(1)').contains('reading')

    cy.get('#app > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > button:nth-child(1)').click()
    cy.get('#app > div > table > tbody > tr:nth-child(1) > td:nth-child(1) > form > input').type('movie')
    cy.get('#app > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > button:nth-child(1)').click()
    cy.get('#app > div > table > tbody > tr:nth-child(1) > td:nth-child(1)').contains('movie')

    cy.get('#app > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > button.delete-btn').click()
    cy.get('#app > div > table > tbody > tr > td:nth-child(1)').contains('running')
